...
export default {
  ...
  scheduleEditor: {
    ...
    guestsLimit: '(Max 10)',
    addGuest: 'Add Guest',
    noGuests: 'No guests yet, click the button below to add',
    ...
    typeRequired: 'Please select schedule type',
    procedureRequired: 'Please enter procedure name',
    topicRequired: 'Please enter lecture topic',
