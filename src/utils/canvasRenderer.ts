...
export class CanvasRenderer {
   ...
   */
  private drawVerticalText(text: string, element: { x: number, y: number, width: number, height: number }, ctx: CanvasRenderingContext2D | OffscreenCanvasRenderingContext2D, fontSize: number): void {
