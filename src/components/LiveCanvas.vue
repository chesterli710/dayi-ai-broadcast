...
// 从planStore中获取直播状态
const { liveLayout, liveSchedule, isStreaming } = storeToRefs(planStore);
...
function initCanvas() {
  ...
  console.log('[LiveCanvas.vue 直播画布] 容器尺寸:', containerRect);
  ...
  console.log('[LiveCanvas.vue 直播画布] 容器尺寸变化:', width, height);
